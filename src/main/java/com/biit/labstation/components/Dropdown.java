...
public class Dropdown {
    ...
    public void selectItem(String parent, String item) {
        ...
        final WebElement element = customChromeDriver.findElementWaiting(By.id(parent)).findElement(By.id("dropdown")).findElement(By.xpath(".//div[@id='content']/a[contains(text(), '"
                + item + "')]"));
    ...
    public void selectItem(String parent, String selector, String item) {
        ...
        final WebElement element = customChromeDriver.findElementWaiting(By.id(parent)).findElement(By.id(selector)).findElement(By.id("dropdown")).findElement(By.xpath(".//div[@id='content']/a[contains(text(), '"
                + item + "')]"));
        new Actions(customChromeDriver.getDriver()).scrollToElement(element).perform();
        element.click();
    }
